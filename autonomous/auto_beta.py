...
class PIDTuningStraight(AutonBase):
    MODE_NAME = "PIDTuningStraight"
    raw_traj = load_swerve_trajectory(MODE_NAME)
...
class BumpyShootTwo(AutonBase):
    MODE_NAME = "BumpyShootTwo"
    raw_traj = load_swerve_trajectory('BumpyShoot')
    raw_second_traj = load_swerve_trajectory(MODE_NAME)
